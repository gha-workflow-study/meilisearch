...
impl FacetedDocidsExtractor {
        ...
        SD: SettingsDelta,
    {
        ...
        // TODO add methods to SettingsDelta to get the new sortable, new asc/desc and new distinct fields
        //      So that we can pass them to the extract_document_facets function.
